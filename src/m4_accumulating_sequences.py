...
def run_test_make_simple_list():
    ...
    # Test 3:
    expected = [52, 53, 54, 55, 56]
    actual = make_simple_list(52, 56)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def run_test_make_less_simple_string():
    ...
    # Test 2:
    expected = '0-1-2-3'
    actual = make_less_simple_string(0, 3)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def draw_shapes(shapes, window):
    ...
    for k in range(len(shapes)):
        ...
        # ------------------------------------------------------------------
        # DONE: 9. Implement and test this function. Make sure you do DONE 8 in
        # main first!
